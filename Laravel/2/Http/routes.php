...
Route::match(['get', 'post'], '/url7/{id}', 'OperacionesController@action3');
...
Route::get('/url10/{a}/{b}', 'OperacionesController@action5')
->where(["a"=>'[0-9]+', "b"=>'[0-9]+']);

Route::get('/url11/{id}', 'OperacionesController@action6');